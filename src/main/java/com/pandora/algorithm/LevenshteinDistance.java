...
public class LevenshteinDistance {
	...
	public static void main(String[] args) {
		LevenshteinDistance lt = new LevenshteinDistance();
		String str = "C60-fullerenes: detection of intracellular����";
		String target = "C_(60)-Fullerenes: detection of intracellular����";
